...
<!-- ranking_model: v1.0 | weights: {ppr:0.45,auth:0.2,test:0.15,doc:0.1,fresh:0.1} | alpha:0.85 | commit:1a5904b | date:2026-07-18 -->
...
- `elf_sym_addr` (line 3585) `static long elf_sym_addr(const Sym *s)`
- `elf_resolve_fixups` (line 3598) `static void elf_resolve_fixups(void)`
- `elf_encode_src` (line 3617) `static void elf_encode_src(LineSrc *src)`
- `elf_layout` (line 3673) `static void elf_layout(void)`
- `elf_write` (line 3705) `static void elf_write(const char *path)`
- `elf_build` (line 3823) `static void elf_build(const char *in_path, const char *out_path)`
- `usage` (line 3899) `static void usage(void)` - *================================================================ CLI * ================================================================*
- `main` (line 3910) `int main(int argc, char **argv)`
...
- `strncat` (line 3946) `strncat(out, ext, CFG_NAME_MAX - strlen(out) - 1);`
